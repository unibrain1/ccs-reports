...
--
-- Host: localhost:8889
-- Generation Time: Jan 24, 2022 at 11:35 PM
...
INSERT INTO `classifiers` (`id`, `classifier`, `name`, `scoring`, `rounds`, `reload`, `barricade`, `table`, `prop`, `strings`, `shoWho`, `movement`, `distance`, `status`) VALUES
